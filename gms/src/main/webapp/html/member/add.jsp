...
<div id="content-box">
	<form id="join-form">
		...
		소속팀
		<input type="radio" name="teamId" value="A"/>야놀자
		<input type="radio" name="teamId" value="B"/>지은집
		<input type="radio" name="teamId" value="D"/>거북왕
		<input type="radio" name="teamId" value="C"/>코딩짱<br>
		프로젝트역할
